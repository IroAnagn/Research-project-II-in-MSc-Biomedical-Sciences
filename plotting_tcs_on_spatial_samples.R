...
plot_raw_image = function(image_id, corrected_mix_mat = corrected_mix_mat, visium = visium) {
  ...
  # Adjust for specific image if necessary
  if(image_id =="OC1") {
  ...
  # Create new Seurat object for plotting
...
### iterate through all images and TCs to plot
