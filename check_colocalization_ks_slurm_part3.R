...
BBPARAM_multicore = BiocParallel::SnowParam(64) ### cluster
...
#   # corr_list = bplapply(1:nrow(par_grid), function(curr_row) { ### overloaded memory
#     # print(curr_row)
...
unique_image_id = unique(spatial_kernel_corr_df_sig$image_id)
for(curr_img in unique_image_id[9]) {
